...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( stbio, stbio, newaccount );
   SET_APP_HANDLER( stbio, stbio, setcode );
   SET_APP_HANDLER( stbio, stbio, setabi );
   SET_APP_HANDLER( stbio, stbio, updateauth );
   SET_APP_HANDLER( stbio, stbio, deleteauth );
   SET_APP_HANDLER( stbio, stbio, linkauth );
   SET_APP_HANDLER( stbio, stbio, unlinkauth );
/*
   SET_APP_HANDLER( stbio, stbio, postrecovery );
   SET_APP_HANDLER( stbio, stbio, passrecovery );
   SET_APP_HANDLER( stbio, stbio, vetorecovery );
*/

   SET_APP_HANDLER( stbio, stbio, canceldelay );
   }
